...
class MyNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=128 * 8 * 8, out_features=280, bias=True)
        self.drop1 = nn.Dropout(0.4)
        self.fc2 = nn.Linear(in_features=280, out_features=250, bias=True)
        self.drop2 = nn.Dropout(0.4)
        self.fc3 = nn.Linear(in_features=250, out_features=140, bias=True)
        self.drop3 = nn.Dropout(0.2)
        self.fc4 = nn.Linear(in_features=140, out_features=128, bias=True)
