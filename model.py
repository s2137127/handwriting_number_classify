...
class MyNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=128, out_features=300, bias=True)
        self.fc2 = nn.Linear(in_features=300, out_features=256, bias=True)
        # self.fc3 = nn.Linear(in_features=256, out_features=256, bias=True)
        # self.fc4 = nn.Linear(in_features=256, out_features=128, bias=True)
        self.fc5 = nn.Linear(in_features=256, out_features=128, bias=True)
        self.fc6 = nn.Linear(in_features=128, out_features=64, bias=True)
